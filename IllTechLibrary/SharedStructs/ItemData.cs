...
{
    public class Item : SSClass
    {
        public Item()
        {
        }

        public Item(List<Object> MembData) : base (MembData) { }
    ...
    public class ItemFortuneLOD : SSClass
    {
        public ItemFortuneLOD()
        {
        }

        public ItemFortuneLOD(List<Object> MembData) : base(MembData) { }
